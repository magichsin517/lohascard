...
export default function ActivityCard({ activity }: { activity: Activity }) {
  ...
  return (
    <Link
      ...
      className="group block bg-paper-raised rounded-2xl overflow-hidden border border-black/5 hover:border-black/15 hover:shadow-[0_4px_20px_-8px_rgba(0,0,0,0.12)] transition-all duration-300"
    >
